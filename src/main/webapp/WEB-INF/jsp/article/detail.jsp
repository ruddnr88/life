<%@ page import="com.project.rko.life.util.Util"%>
...
<script>
	...
	function ReplyList__drawReply(reply) {
		...
		html += '<td style="text-align:center;">' + reply.id + '</td>';
		html += '<td class="visible-on-md-up">' + reply.regDate + '</td>';
		html += '<td style="text-align:center;" class="visible-on-md-up">'
				+ reply.extra.writer + '</td>';
		html += '<td>';
